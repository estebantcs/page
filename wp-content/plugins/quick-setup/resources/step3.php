...
return stripslashes_deep( $data[$field][$key] );
}
...
return stripslashes_deep( $data['enabled'][$key] );
}
...
<?php if ( !empty( $page['tip'] ) ) : ?>
<a href="javascript:;" class="q-setup-info-icn" title="<?php esc_attr_e( $page['tip'], 'gd_quicksetup' ); ?>"></a>
<?php endif; ?>
</div>
<?php endif; ?>
</div>
...
<input type="hidden" name="enabled[custom_page_{{idx}}]" value="false" />
...
<input type="checkbox" id="q-setup-final-warning"> <label for="q-setup-final-warning"><?php _e( 'I understand that clicking "Publish Website" will cause my database to be overwritten.', 'gd_quicksetup' ); ?></label>
<ul class="q-setup-btn-wrap clear-fix">
<li>
<a href="javascript:;" class="button-primary gd-quicksetup-wizard-submit button-disabled" disabled><?php _e( 'Publish Website', 'gd_quicksetup' ); ?></a>
</li>
<li>
